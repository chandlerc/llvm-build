...
setup_build_dir "${1:-gcc-opt}"

export CC=gcc
export CXX=g++

# Note: GCC spells "line tables only" as -g1; -gmlt is Clang-only.
export CFLAGS='-no-canonical-prefixes -O3 -DNDEBUG -march=native -g1 -fno-omit-frame-pointer'
